...
document.write("<h5>EJEMPLO 1: INICIAR LA VARIABLE CIUDAD</h5>");
let miCiudad;
miCiudad = "Malaga";
...
document.write("Hoy es Jueves? " + esJueves + "</br></br>");
...
document.writeln("1. Informacion sobre : </b>" + nombre + " " + apellidos + "</b>");
document.writeln("   · Edad = " + edad + " años");
document.writeln("   · Altura = " + altura + " cm");
document.writeln("   · Ciudad = " + ciudad);
document.writeln("   · ¿Te gusta la playa? = " + (gustaPlaya ? "SI" : "NO"));
document.writeln("   · ¿Te gusta la montaña? = " + (gustaMonte ? "SI" : "NO"));
document.writeln("   · ¿Te gusta el chocolate? = " + (gustaChocolate ? "SI" : "NO"));
document.writeln("   · ¿Tienes mascota? = " + (tienesMascota ? "SI" : "NO"));
...
gustaChocolate = "true";
tienesMascota = "false";
document.writeln("2. Informacion sobre : </b>" + nombre + " " + apellidos + "</b>");
document.writeln("   · Edad = " + edad + " años");
document.writeln("   · Altura = " + altura + " cm");
document.writeln("   · Ciudad = " + ciudad);
document.writeln("   · ¿Te gusta la playa? = " + (gustaPlaya ? "SI" : "NO"));
document.writeln("   · ¿Te gusta la montaña? = " + (gustaMonte ? "SI" : "NO"));
document.writeln("   · ¿Te gusta la chocolate? = " + (gustaChocolate ? "SI" : "NO"));
document.writeln("   · ¿Tienes mascota? = " + (tienesMascota ? "SI" : "NO"));
